...
public class ProfilePackageImpl extends EPackageImpl implements ProfilePackage {
	 ...
	 * @see mil.jpeojtrs.sca.profile.ProfilePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static ProfilePackage initGen() {
	...
	public static ProfilePackage init() {
		final ProfilePackage retVal = ProfilePackageImpl.initGen();
	...
	public void createPackageContents() {
		...
		createEAttribute(profileEClass, PROFILE__FILENAME);
		createEAttribute(profileEClass, PROFILE__TYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDocumentRoot_Profile(), this.getProfile(), null, "profile", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(profileEClass, Profile.class, "Profile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProfile_Filename(), theXMLTypePackage.getString(), "filename", null, 1, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProfile_Type(), theXMLTypePackage.getString(), "type", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
