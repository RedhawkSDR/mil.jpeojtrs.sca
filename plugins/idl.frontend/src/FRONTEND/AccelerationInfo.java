...
/**
* FRONTEND/AccelerationInfo.java .
...
public final class AccelerationInfo implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public AccelerationInfo (boolean _valid, String _datum, String _coordinate_system, double _x, double _y, double _z)
  {
    valid = _valid;
    datum = _datum;
