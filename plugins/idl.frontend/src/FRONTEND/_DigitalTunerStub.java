...
/**
* FRONTEND/_DigitalTunerStub.java .
...
public class _DigitalTunerStub extends org.omg.CORBA.portable.ObjectImpl implements FRONTEND.DigitalTuner
{
  ...
  public void setTunerOutputSampleRate (String id, double sr) throws FRONTEND.FrontendException, FRONTEND.BadParameterException, FRONTEND.NotSupportedException
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setTunerOutputSampleRate", true);
                $out.write_string (id);
                $out.write_double (sr);
                $in = _invoke ($out);
                return;
                ...
                setTunerOutputSampleRate (id, sr        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public double getTunerOutputSampleRate (String id) throws FRONTEND.FrontendException, FRONTEND.BadParameterException, FRONTEND.NotSupportedException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTunerOutputSampleRate", true);
                $out.write_string (id);
                $in = _invoke ($out);
                ...
                return getTunerOutputSampleRate (id        );
            } finally {
                _releaseReply ($in);
            }
