	...
	public void setDeployDevice(DeployOnDevice newDeployDevice) {
		if (newDeployDevice != deployDevice) {
			...
			if (newDeployDevice != null)
				msgs = ((InternalEObject)newDeployDevice).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DcdPackage.DCD_COMPONENT_PLACEMENT__DEPLOY_DEVICE, null, msgs);
	...
	public void setCompositePartOfDeviceGen(CompositePartOfDevice newCompositePartOfDevice) {
		if (newCompositePartOfDevice != compositePartOfDevice) {
			...
			if (newCompositePartOfDevice != null)
				msgs = ((InternalEObject)newCompositePartOfDevice).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DcdPackage.DCD_COMPONENT_PLACEMENT__COMPOSITE_PART_OF_DEVICE, null, msgs);
			msgs = basicSetCompositePartOfDevice(newCompositePartOfDevice, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcdPackage.DCD_COMPONENT_PLACEMENT__COMPOSITE_PART_OF_DEVICE, newCompositePartOfDevice, newCompositePartOfDevice));
	}
	...
	public void setDevicePkgFile(DevicePkgFile newDevicePkgFile) {
		if (newDevicePkgFile != devicePkgFile) {
			...
			if (newDevicePkgFile != null)
				msgs = ((InternalEObject)newDevicePkgFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DcdPackage.DCD_COMPONENT_PLACEMENT__DEVICE_PKG_FILE, null, msgs);
