...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Host Collocation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class HostCollocationImpl extends EObjectImpl implements HostCollocation {

	/**
	 * The cached value of the '{@link #getComponentPlacement() <em>Component Placement</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	protected EClass eStaticClass() {
		return SadPackage.Literals.HOST_COLLOCATION;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SadPackage.HOST_COLLOCATION__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SadPackage.HOST_COLLOCATION__NAME, oldName, name));
	}
