...
public class FindByStubImpl extends EObjectImpl implements FindByStub {
	...
	public NotificationChain basicSetNamingService(NamingService newNamingService, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PartitioningPackage.FIND_BY_STUB__NAMING_SERVICE, oldNamingService,
				newNamingService);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setNamingService(NamingService newNamingService) {
		if (newNamingService != namingService) {
			...
			if (namingService != null)
				msgs = ((InternalEObject) namingService).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PartitioningPackage.FIND_BY_STUB__NAMING_SERVICE, null,
					msgs);
			if (newNamingService != null)
				msgs = ((InternalEObject) newNamingService).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PartitioningPackage.FIND_BY_STUB__NAMING_SERVICE, null,
					msgs);
	...
	public NotificationChain basicSetDomainFinder(DomainFinder newDomainFinder, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PartitioningPackage.FIND_BY_STUB__DOMAIN_FINDER, oldDomainFinder,
				newDomainFinder);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDomainFinder(DomainFinder newDomainFinder) {
		if (newDomainFinder != domainFinder) {
			...
			if (domainFinder != null)
				msgs = ((InternalEObject) domainFinder).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PartitioningPackage.FIND_BY_STUB__DOMAIN_FINDER, null,
					msgs);
			if (newDomainFinder != null)
				msgs = ((InternalEObject) newDomainFinder).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PartitioningPackage.FIND_BY_STUB__DOMAIN_FINDER, null,
					msgs);
	...
	public NotificationChain basicSetInterface(ComponentSupportedInterfaceStub newInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PartitioningPackage.FIND_BY_STUB__INTERFACE, oldInterface,
				newInterface);
			if (msgs == null)
				msgs = notification;
			else
