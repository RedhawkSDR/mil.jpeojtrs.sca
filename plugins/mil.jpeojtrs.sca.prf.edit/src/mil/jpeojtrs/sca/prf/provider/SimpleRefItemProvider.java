...
/**
 * This is the item provider adapter for a {@link mil.jpeojtrs.sca.prf.SimpleRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleRefItemProvider extends AbstractPropertyRefItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SimpleRefItemProvider(AdapterFactory adapterFactory) {
	...
	public static String getValueText(SimpleRef ref, String value) {
		...
		Simple property = ref.getProperty();
		if (property == null) {
			return value;
		}
