...
/**
 * This is the item provider adapter for a {@link mil.jpeojtrs.sca.dmd.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_usesIdentifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_usesIdentifier_feature", "_UI_Service_type"),
				 DmdPackage.Literals.SERVICE__USES_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(DmdPackage.Literals.SERVICE__FIND_BY);
		}
	...
	public String getText(Object object) {
		String label = ((Service)object).getUsesIdentifier();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DmdPackage.Literals.SERVICE__FIND_BY,
				 DmdFactory.eINSTANCE.createFindBy()));
	}
