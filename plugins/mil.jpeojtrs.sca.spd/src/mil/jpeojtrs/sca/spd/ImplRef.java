 ...
 * <ul>
 *   <li>{@link mil.jpeojtrs.sca.spd.ImplRef#getRefid <em>Refid</em>}</li>
 * </ul>
 * </p>
 *
 * @see mil.jpeojtrs.sca.spd.SpdPackage#getImplRef()
 * @model extendedMetaData="name='implRef' kind='empty'"
 * @generated
 */
public interface ImplRef extends EObject {
	 ...
	 * @see #setRefid(String)
	 * @see mil.jpeojtrs.sca.spd.SpdPackage#getImplRef_Refid()
	...
	/**
	 * Sets the value of the '{@link mil.jpeojtrs.sca.spd.ImplRef#getRefid <em>Refid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
