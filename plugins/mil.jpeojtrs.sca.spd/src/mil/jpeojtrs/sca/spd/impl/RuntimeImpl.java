 ...
 * @generated
 */
public class RuntimeImpl extends EObjectImpl implements mil.jpeojtrs.sca.spd.Runtime {
	...
	protected EClass eStaticClass() {
		return SpdPackage.Literals.RUNTIME;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdPackage.RUNTIME__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdPackage.RUNTIME__VERSION, oldVersion, version));
	}
