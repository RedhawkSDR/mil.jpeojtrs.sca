 ...
 * @generated
 */
public class ProgrammingLanguageImpl extends EObjectImpl implements ProgrammingLanguage {
	...
	protected EClass eStaticClass() {
		return SpdPackage.Literals.PROGRAMMING_LANGUAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdPackage.PROGRAMMING_LANGUAGE__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdPackage.PROGRAMMING_LANGUAGE__VERSION, oldVersion, version));
	}
