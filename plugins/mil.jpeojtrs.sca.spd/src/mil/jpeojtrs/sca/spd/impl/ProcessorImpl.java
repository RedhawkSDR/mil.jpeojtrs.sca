 ...
 * <ul>
 *   <li>{@link mil.jpeojtrs.sca.spd.impl.ProcessorImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessorImpl extends EObjectImpl implements Processor {
	...
	protected EClass eStaticClass() {
		return SpdPackage.Literals.PROCESSOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpdPackage.PROCESSOR__NAME, oldName, name));
	}
