 ...
 * <ul>
 *   <li>{@link mil.jpeojtrs.sca.prf.impl.KindImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class KindImpl extends EObjectImpl implements Kind {
	 ...
	 * @ordered
	 */
	protected PropertyConfigurationType type = TYPE_EDEFAULT;
	/**
	...
	protected EClass eStaticClass() {
		return PrfPackage.Literals.KIND;
	}
	...
	public void setType(PropertyConfigurationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrfPackage.KIND__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PrfPackage.KIND__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
