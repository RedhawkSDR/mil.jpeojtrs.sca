...
/**
 * This is the item provider adapter for a {@link mil.jpeojtrs.sca.profile.Profile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Profile_filename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Profile_filename_feature", "_UI_Profile_type"),
				 ProfilePackage.Literals.PROFILE__FILENAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Profile_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Profile_type_feature", "_UI_Profile_type"),
				 ProfilePackage.Literals.PROFILE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Profile)object).getFilename();
