 ...
 * @generated
 */
public class ProvidesPortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PartitioningPackage.Literals.PROVIDES_PORT__PROVIDES_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProvidesPort_type") :
			getString("_UI_ProvidesPort_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.PROVIDES_PORT__DEVICE_THAT_LOADED_THIS_COMPONENT_REF,
				 PartitioningFactory.eINSTANCE.createDeviceThatLoadedThisComponentRef()));

		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.PROVIDES_PORT__DEVICE_USED_BY_THIS_COMPONENT_REF,
				 PartitioningFactory.eINSTANCE.createDeviceUsedByThisComponentRef()));

		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.PROVIDES_PORT__FIND_BY,
