...
public class UsesDeviceStubItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	 ...
	 * @generated
	 */
	public UsesDeviceStubItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addUsesDevicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
			getString("_UI_UsesDeviceStub_usesDevice_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_UsesDeviceStub_usesDevice_feature", "_UI_UsesDeviceStub_type"),
			PartitioningPackage.Literals.USES_DEVICE_STUB__USES_DEVICE, true, false, true, null, null, null));
	}
	...
	public Collection< ? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PartitioningPackage.Literals.USES_DEVICE_STUB__PROVIDES_PORT_STUBS);
			childrenFeatures.add(PartitioningPackage.Literals.USES_DEVICE_STUB__USES_PORT_STUBS);
			childrenFeatures.add(PartitioningPackage.Literals.USES_DEVICE_STUB__INTERFACE);
		}
	...
	/**
	 * This returns UsesDeviceStub.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UsesDeviceStub"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_UsesDeviceStub_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UsesDeviceStub.class)) {
