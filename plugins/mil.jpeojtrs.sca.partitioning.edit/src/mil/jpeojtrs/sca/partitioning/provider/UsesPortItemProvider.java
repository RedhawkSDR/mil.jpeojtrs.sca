 ...
 * @generated
 */
public class UsesPortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PartitioningPackage.Literals.USES_PORT__USES_INDENTIFIER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UsesPort_type") :
			getString("_UI_UsesPort_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.USES_PORT__DEVICE_THAT_LOADED_THIS_COMPONENT_REF,
				 PartitioningFactory.eINSTANCE.createDeviceThatLoadedThisComponentRef()));

		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.USES_PORT__DEVICE_USED_BY_THIS_COMPONENT_REF,
				 PartitioningFactory.eINSTANCE.createDeviceUsedByThisComponentRef()));

		newChildDescriptors.add
			(createChildParameter
				(PartitioningPackage.Literals.USES_PORT__FIND_BY,
