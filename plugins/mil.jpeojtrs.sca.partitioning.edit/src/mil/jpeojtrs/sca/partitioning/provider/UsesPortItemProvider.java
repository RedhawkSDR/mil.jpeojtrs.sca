...
/**
 * This is the item provider adapter for a {@link mil.jpeojtrs.sca.partitioning.UsesPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UsesPortItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public UsesPortItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection< ? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PartitioningPackage.Literals.USES_PORT__COMPONENT_INSTANTIATION_REF);
			childrenFeatures.add(PartitioningPackage.Literals.USES_PORT__DEVICE_THAT_LOADED_THIS_COMPONENT_REF);
			childrenFeatures.add(PartitioningPackage.Literals.USES_PORT__DEVICE_USED_BY_THIS_COMPONENT_REF);
			childrenFeatures.add(PartitioningPackage.Literals.USES_PORT__DEVICE_USED_BY_APPLICATION);
			childrenFeatures.add(PartitioningPackage.Literals.USES_PORT__FIND_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PartitioningPackage.Literals.USES_PORT__DEVICE_THAT_LOADED_THIS_COMPONENT_REF,
			PartitioningFactory.eINSTANCE.createDeviceThatLoadedThisComponentRef()));

		newChildDescriptors.add(createChildParameter(PartitioningPackage.Literals.USES_PORT__DEVICE_USED_BY_THIS_COMPONENT_REF,
			PartitioningFactory.eINSTANCE.createDeviceUsedByThisComponentRef()));

		newChildDescriptors.add(createChildParameter(PartitioningPackage.Literals.USES_PORT__DEVICE_USED_BY_APPLICATION,
			PartitioningFactory.eINSTANCE.createDeviceUsedByApplication()));

		newChildDescriptors.add(createChildParameter(PartitioningPackage.Literals.USES_PORT__FIND_BY, PartitioningFactory.eINSTANCE.createFindBy()));
	}
